...
![图 3-1：一维高斯函数在不同参数下的对比图](pic/ch3_fig1.png)
...
![图 3-2：二维高斯分布的等高线对比图](pic/ch3_fig2.png)
...
![图 3-3：协方差矩阵分解的几何示意图](pic/ch3_fig3.png)
...
![图 3-4：高斯混合的叠加示意图](pic/ch3_fig4.png)
...
*上一章：[第二章：视觉基础——相机、投影与点云](chapter2.md)  | 下一章：[第四章：球谐函数与外观建模](chapter4.md)*
