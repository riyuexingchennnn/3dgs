...
### [第一章：三维重建是什么，为什么重要](./docs/chapter1.md)
...
### [第二章：视觉基础——相机、投影与点云](./docs/chapter2.md)
...
### [第三章：高斯函数与概率基础](./docs/chapter3.md)
...
### [第四章：球谐函数与外观建模](./docs/chapter4.md)
...
### [第五章：体渲染与 Alpha 合成](./docs/chapter5.md)
...
### [第六章：3DGS 核心算法详解](./docs/chapter6.md)
...
### [第七章：从原始论文到开源代码](./docs/chapter7.md)
...
### [第八章：数据准备与训练实战](./docs/chapter8.md)
...
### [第九章：主流改进方向与前沿论文](./docs/chapter9.md)
...
### [第十章：成为贡献者——如何迭代改进系统](./docs/chapter10.md)
